...
#define N_RPM_PULSE_PER_REV                 (1U)              /* Number of pulses per rotation */
#define RPM_PULSE_INPUT_PIN                 (46U)             /* Input pin for RPM pulse input */
...
#define GENERATE_RPM_PIN                    (2U)              /* Pin on which pulse will be generated for simulating RPM signal */
#define RPM_SET_POINT                       (200U)            /* Rpm set point */
