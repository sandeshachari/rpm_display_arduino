...
#define RPM_PULSE_TIMEOUT_MS                (1500U)           /* RPM pulse timeout. After this timeout, 0 RPM will be displayed */
...
#define TM1637_DISPLAY_UPDATE_RATE_MS       (100U)
#define TM1637_DISPLAY_CLK_PIN              (21U)
#define TM1637_DISPLAY_DIO_PIN              (20U)
